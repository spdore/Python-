...
class Bullet(pygame.sprite.Sprite):
	def __init__(self):
		...
		# 子弹四个方向(上下左右)
		self.bullets = ['images/bullet/bullet_d_up.png', 'images/bullet/bullet_d_down.png', 'images/bullet/bullet_d_left.png', 'images/bullet/bullet_d_right.png']
		# 子弹方向(默认向上)
	...
	def move(self):
		...
		# 到地图边缘后消失
		if (self.rect.top < 1) or (self.rect.bottom > 630 - 1) or (self.rect.left < 1) or (self.rect.right > 630 - 1):
			self.being = False