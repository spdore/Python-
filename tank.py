...
class myTank(pygame.sprite.Sprite):
	def __init__(self, player):
		...
		if player == 1:
			self.tanks = [
				'images/myTank/fighter1-1.png', 'images/myTank/fighter1-2.png','images/myTank/fighter1-3.png','images/myTank/fighter2-1.png', 'images/myTank/fighter2-2.png','images/myTank/fighter2-3.png'
						  ]
		elif player == 2:
...
class enemyTank(pygame.sprite.Sprite):
	def __init__(self, x=None, kind=None, is_red=None):
		...
		self.tank_boss = ['images/enemyTank/boss.png']
		self.tanks = [self.tanks1, self.tanks2, self.tanks3, self.tanks4, self.tank_boss]
		# 是否携带食物(红色的坦克携带食物)
		if is_red is None:
